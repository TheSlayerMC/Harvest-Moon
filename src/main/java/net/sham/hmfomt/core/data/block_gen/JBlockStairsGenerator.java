...
public class JBlockStairsGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for(String name : HMBlocks.stairsBlockName) {
            ...
            String blockInnerModelDir = "../src/main/resources/assets/hmfomt/models/block/" + name + "_inner.json";
            String blockOuterModelDir = "../src/main/resources/assets/hmfomt/models/block/" + name + "_outer.json";
    ...
    public void getBlockModel(String modID, String name) {
        ...
        writeToBlockModelFile(blockInnerModelWriter, "    \"bottom\": \"" + modID + ":" + "block/" + HMBlockProps.getTextureFromName(name) + "\",");
        writeToBlockModelFile(blockInnerModelWriter, "    \"side\": \"" + modID + ":" + "block/" + HMBlockProps.getTextureFromName(name) + "\",");
        writeToBlockModelFile(blockInnerModelWriter, "    \"top\": \"" + modID + ":" + "block/" + HMBlockProps.getTextureFromName(name) + "\"");
        writeToBlockModelFile(blockInnerModelWriter, "  }");
        writeToBlockModelFile(blockInnerModelWriter, "}");
        ...
        writeToBlockModelFile(blockOuterModelWriter, "    \"bottom\": \"" + modID + ":" + "block/" + HMBlockProps.getTextureFromName(name) + "\",");
        writeToBlockModelFile(blockOuterModelWriter, "    \"side\": \"" + modID + ":" + "block/" + HMBlockProps.getTextureFromName(name) + "\",");
        writeToBlockModelFile(blockOuterModelWriter, "    \"top\": \"" + modID + ":" + "block/" + HMBlockProps.getTextureFromName(name) + "\"");
        writeToBlockModelFile(blockOuterModelWriter, "  }");
        writeToBlockModelFile(blockOuterModelWriter, "}");
    }
