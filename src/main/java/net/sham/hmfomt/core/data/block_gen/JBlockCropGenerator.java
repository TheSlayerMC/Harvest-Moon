...
public class JBlockCropGenerator extends BasicFileGenerator {
    ...
    public void generate(String name, int maxStages) {
        ...
        String blockModelDir0 = "../src/main/resources/assets/hmfomt/models/block/" + name + "_0.json";
        String blockModelDir1 = "../src/main/resources/assets/hmfomt/models/block/" + name + "_1.json";
        String blockModelDir2 = "../src/main/resources/assets/hmfomt/models/block/" + name + "_2.json";
        String blockModelDir3 = "../src/main/resources/assets/hmfomt/models/block/" + name + "_3.json";
        String blockModelDir4 = "../src/main/resources/assets/hmfomt/models/block/" + name + "_4.json";
        String blockModelDir5 = "../src/main/resources/assets/hmfomt/models/block/" + name + "_5.json";
        String blockModelDir6 = "../src/main/resources/assets/hmfomt/models/block/" + name + "_6.json";
        String blockModelDir7 = "../src/main/resources/assets/hmfomt/models/block/" + name + "_7.json";
        ...
        if(itemModelWriter != null) {
            getBlockItem(HarvestMoon.MOD_ID, name, maxStages);
            getBlockModel(HarvestMoon.MOD_ID, name, maxStages);
            getBlockstate(HarvestMoon.MOD_ID, name, maxStages);
