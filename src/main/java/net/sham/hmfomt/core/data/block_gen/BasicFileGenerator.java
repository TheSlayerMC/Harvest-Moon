...
public class BasicFileGenerator {
    ...
    public void generateBasicFile(String name, String extension) {
        String itemFileDir = "../src/main/resources/assets/hmfomt/items/" + name + ".json";
        ...
        getItemFile(HarvestMoon.MOD_ID, name, extension);
        itemModelInit();
    }

    public void generateSpawnEggFile(String name, int colour1, int colour2) {
        String itemFileDir = "../src/main/resources/assets/hmfomt/items/" + name + ".json";
        File itemFile = new File(itemFileDir);
        itemFile.mkdirs();
        try {
        ...
        getSpawnEggItem(colour1, colour2);
        itemModelInit();
    }
    ...
    public void generateBasicFile(boolean item, String name) {
        ...
        getItemFile(item, HarvestMoon.MOD_ID, name);
        itemModelInit();
    }
    ...
    public void getSpawnEggItem(int colour1, int colour2) {
        writeToItemFile("{");
        writeToItemFile("  \"model\": {");
        writeToItemFile("    \"type\": \"minecraft:model\",");
        writeToItemFile("    \"model\": \"minecraft:item/template_spawn_egg\",");
        writeToItemFile("    \"tints\": [");
        writeToItemFile("      {");
        writeToItemFile("        \"type\": \"minecraft:constant\",");
        writeToItemFile("        \"value\": " + colour1);
        writeToItemFile("      },");
        writeToItemFile("      {");
        writeToItemFile("        \"type\": \"minecraft:constant\",");
        writeToItemFile("        \"value\": " + colour2);
        writeToItemFile("      }");
        writeToItemFile("    ]");
        writeToItemFile("  }");
        writeToItemFile("}");
    ...
    public void getShieldItem(String name) {
        ...
        writeToItemFile("      \"base\": \"hmfomt:item/" + name + "\",");
        writeToItemFile("      \"model\": {");
        writeToItemFile("        \"type\": \"hmfomt:" + name + "\"");
        writeToItemFile("      }");
        writeToItemFile("    },");
        writeToItemFile("    \"on_true\": {");
        writeToItemFile("      \"type\": \"minecraft:special\",");
        writeToItemFile("      \"base\": \"hmfomt:item/" + name + "_blocking\",");
        writeToItemFile("      \"model\": {");
        writeToItemFile("        \"type\": \"hmfomt:" + name + "\"");
        writeToItemFile("      }");
        writeToItemFile("    },");
    ...
    public void getBowItem(String name) {
        ...
        writeToItemFile("    \"on_false\": {");
        writeToItemFile("      \"type\": \"minecraft:model\",");
        writeToItemFile("      \"model\": \"hmfomt:item/" + name + "\"");
        writeToItemFile("    },");
        writeToItemFile("    \"on_true\": {");
        ...
        writeToItemFile("          \"model\": {");
        writeToItemFile("            \"type\": \"minecraft:model\",");
        writeToItemFile("      \"model\": \"hmfomt:item/" + name + "_1\"");
        writeToItemFile("          },");
        ...
        writeToItemFile("          \"model\": {");
        writeToItemFile("            \"type\": \"minecraft:model\",");
        writeToItemFile("      \"model\": \"hmfomt:item/" + name + "_2\"");
        writeToItemFile("          },");
        ...
        writeToItemFile("        \"type\": \"minecraft:model\",");
        writeToItemFile("      \"model\": \"hmfomt:item/" + name + "_0\"");
        writeToItemFile("      },");
