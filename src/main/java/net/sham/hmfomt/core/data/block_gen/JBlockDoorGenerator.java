...
public class JBlockDoorGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for(String name : HMBlocks.doorBlockName) {
            String itemModelDir = "../src/main/resources/assets/hmfomt/models/item/" + name + ".json";
            String blockBLModelDir = "../src/main/resources/assets/hmfomt/models/block/" + name + "_bottom_left.json";
            String blockBRModelDir = "../src/main/resources/assets/hmfomt/models/block/" + name + "_bottom_right.json";
            String blockTLModelDir = "../src/main/resources/assets/hmfomt/models/block/" + name + "_top_left.json";
            String blockTRModelDir = "../src/main/resources/assets/hmfomt/models/block/" + name + "_top_right.json";
            String blockBLOModelDir = "../src/main/resources/assets/hmfomt/models/block/" + name + "_bottom_left_open.json";
            String blockBROModelDir = "../src/main/resources/assets/hmfomt/models/block/" + name + "_bottom_right_open.json";
            String blockTLOModelDir = "../src/main/resources/assets/hmfomt/models/block/" + name + "_top_left_open.json";
            String blockTROModelDir = "../src/main/resources/assets/hmfomt/models/block/" + name + "_top_right_open.json";
